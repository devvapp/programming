 ...
 */
public class DjistrasShortestPath {
    ...
    public static void main(String[] args) {
        ...
        DjistrasShortestPath dsp = new DjistrasShortestPath();
        dsp.djistrasShortestPath(graph, "0");
    }
     ...
     */
    public void djistrasShortestPath(Map<String, LinkedList<WeightedUndirectedGraphBuilder.Node>> graph, String src){
